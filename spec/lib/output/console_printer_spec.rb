...
RSpec.describe Output::ConsolePrinter do
  ...
  let(:expected_output) do
    <<~OUTPUT
      ...
      ├─────┼─────────┼─────────┼─────────┼──────────────┼──────────┼───────────────┼─────────────────┼───────────────┼──────┤
      │ 65  │ $46,758 │ $60,600 │ $30,310 │           $0 │ -        │      $137,668 │              $0 │ rrsp          │ 1.0% │
      │ 66  │ $13,184 │ $61,206 │ $30,623 │           $0 │ -        │      $105,013 │              $0 │ rrsp          │ 1.0% │
      │ 67  │      $0 │ $44,802 │ $30,940 │           $0 │ -        │       $75,741 │              $0 │ rrsp, taxable │ 1.0% │
      │ 68  │      $0 │ $14,939 │ $31,259 │           $0 │ -        │       $46,199 │              $0 │ taxable       │ 1.0% │
      │ 69  │      $0 │      $0 │ $16,361 │           $0 │ -        │       $16,361 │              $0 │ taxable, tfsa │ 1.0% │
      └─────┴─────────┴─────────┴─────────┴──────────────┴──────────┴───────────────┴─────────────────┴───────────────┴──────┘
